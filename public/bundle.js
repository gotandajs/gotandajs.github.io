...
(0, _voronoi2.default)();
_reactDom2.default.render(_react2.default.createElement(_slack2.default, null), document.querySelector('#slack_form'));

},{"./slack.jsx":164,"./voronoi":165,"react":158,"react-dom":2}],164:[function(require,module,exports){
'use strict';
...
var API_BASE = 'https://api.hotolab.net/gotandajs/slack';
...
var Slack = (function (_React$Component) {
  _inherits(Slack, _React$Component);

  function Slack(props) {
    _classCallCheck(this, Slack);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Slack).call(this, props));
    ...
    // 参加人数とオンライン人数を取得
    _superagent2.default.get(API_BASE).end(function (err, res) {
      if (err) {
        return;
      }
      _this.setState({ info: res.body });
    });
    return _this;
  }
  ...
  _createClass(Slack, [{
    ...
    value: function render() {
      var total = this.state.info.total === undefined ? '-' : this.state.info.total;
      var online = this.state.info.online === undefined ? '-' : this.state.info.online;
      var Success = this.state.invitation_status === INVITATION_STATUS.SUCCESS ? _react2.default.createElement(
        'p',
        { className: 'success' },
        '招待メールを送信しました！'
      ) : null;
      var errorMsg = this.getErrorMessage();
      var Error = errorMsg ? _react2.default.createElement(
        'p',
        { className: 'error' },
        errorMsg
      ) : null;
      return _react2.default.createElement(
        'div',
        { className: 'invitation_' + this.state.invitation_status },
    ...
    value: function onSubmit(event) {
      ...
      if (this.state.invitation_status !== INVITATION_STATUS.UNSENT) {
        return;
      }

      var email = this.getEmail();
      if (email === null) {
        return this.handleError('empty_email');
      }
      if (email === false) {
        return this.handleError('invalid_email');
      }

      this.setState({ invitation_status: INVITATION_STATUS.SENDING, error: null });

      _superagent2.default.post(API_BASE).send({ email: email }).end(function (err, res) {
        if (err) {
          return _this2.handleError(err);
        }
        res.body.ok ? _this2.setState({ invitation_status: INVITATION_STATUS.SUCCESS }) : _this2.handleError(res.body.error);
      });
    }
    ...
    value: function handleError(msg) {
      ...
      console.warn(msg);
      setTimeout(function () {
        return _this3.setState({ invitation_status: INVITATION_STATUS.UNSENT });
      }, 1000);
    }
    ...
    value: function getErrorMessage() {
      ...
      return INVITATION_ERROR_MESSAGE[this.state.error] !== undefined ? INVITATION_ERROR_MESSAGE[this.state.error] : INVITATION_ERROR_MESSAGE.default;
    }
  }]);
